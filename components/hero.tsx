    ...
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="absolute inset-0 pointer-events-none">
          ...
          >
            <motion.div
              className="w-16 h-16 rounded-full bg-pink-300 border-4 border-white shadow-lg flex items-center justify-center"
          ...
          >
            <motion.div
              className="w-20 h-20 rounded-full bg-blue-300 border-4 border-white shadow-lg flex items-center justify-center"
          ...
          >
            <motion.div
              className="w-14 h-14 rounded-full bg-amber-300 border-4 border-white shadow-lg flex items-center justify-center"
          ...
          >
            <motion.div
              className="w-16 h-16 rounded-full bg-orange-300 border-4 border-white shadow-lg flex items-center justify-center"
        ...
        <div className="relative z-10 text-center space-y-8 max-w-4xl mx-auto">
          ...
          >
            ...
            ></motion.div>
            <span className="text-xs font-semibold text-emerald-700 uppercase tracking-wider">SMART SHOPPING</span>
          </motion.div>
          ...
          >
            ...
            >
              Our Chrome extension automatically finds cashback, coupons, and exclusive deals at checkout. Earn rewards
              while you shop without lifting a finger.
            </motion.p>
          </motion.div>
